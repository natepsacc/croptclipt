...
while True:
    ...
    inputFile = str("vInput/input14.mp4")
    ...
    side=right
    #720 x 360
    x,y,h,w = randrange(100,600),0,720,380
    x2,y2,h2,w2 = randrange(500,720),0,720,380
    ...
    final_clip = CompositeVideoClip([final_clip_notext, title])
